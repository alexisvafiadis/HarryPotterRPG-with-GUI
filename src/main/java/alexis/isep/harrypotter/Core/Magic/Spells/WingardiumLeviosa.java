...
public class WingardiumLeviosa extends ItemSpell {
    ...
    public void tryForFirstTime() {
        inputParser.waitForConfirmation("Aim your wand at the object you want to levitate and concentrate on it. Visualize the object lifting up off the ground and floating in the air.\n" +
